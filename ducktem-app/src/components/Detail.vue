    ...
    <section class="main-wrap">
      ...
      <section class="detail-container">
        <div class="detail-container-title">
          <h1>뉴진스 비공굿 판매(포카, 떡메)</h1>
          <span class="detail-category">비공식 굿즈 > 문구류</span>
          <span>1분전</span>
        </div>
        <div class="detail-icon">
          ...
          <div>
            <img onclick="location.href='/member/my-page/review/report.html'" src="/image/icon/icon-alert.svg" alt="" />
          </div>
          <div>
      ...
      <section>
        <ul class="detail-button">
          <li>
            <a class="btn btn-tag" href="">Newjeans</a>
          </li>
          <li>
            <a class="btn btn-tag" href="">포카</a>
          </li>
          <li>
            <a class="btn btn-tag" href="">Aespa</a>
          </li>
          <li>
            <a class="btn btn-tag" href="">Aespa</a>
          </li>
