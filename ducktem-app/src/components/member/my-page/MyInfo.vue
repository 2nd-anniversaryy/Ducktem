  ...
  <main>
    <section class="main-wrap">
      ...
      <section class="input-area">
        <div><label for="">닉네임</label><input type="text" /></div>
        <div><label for="">소개글</label><textarea id="" name="" /></div>
        <div><label for="">이메일</label><input type="text" /></div>
        <div><label for="">비밀번호</label><input type="text" /></div>
