<template>
  <div class="login-body">
    ...
    <div class="login-header">
      ...
      <div class="login-logo">Ducktem</div>
    </div>
        ...
        <form action="signup">
          ...
          <div class="signup-container">
            ...
            <div>
              ...
              <input id="birthday" name="birthday" type="date" placeholder="(-)을 제외하고 입력해주세요" />
            </div>

            <div>
              <label class="required" for="signup-agree">약관동의</label>
              <div class="detail">
                설명을 잘 읽어보시고 동의해주세요. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절..
                구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절..
                구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절..설명을 잘
                읽어보시고 동의해주세요. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절..설명을 잘 읽어보시고 동의해주세요. 설명을 잘
                읽어보시고 동의해주세요. 설명을 잘 읽어보시고 동의해주세요. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절.. 구구절절..
                구구절절..설명을 잘 읽어보시고 동의해주세요. 설명을 잘 읽어보시고 동의해주세요. 구구절절..
              </div>
              <div class="signup-agree">
                <span>설명을 잘 읽었고 약관에 동의합니다.</span>
                <input id="signup-agree" class="check" name="signup-agree" type="checkbox" required />
              </div>
            </div>
          </div>
